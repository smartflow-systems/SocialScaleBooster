...
(function() {
  ...
  // Menu configuration for SmartFlow Systems social media platform
  const menuSections = [
    {
      title: "Workspace",
      items: [
        ...
        { label: "Marketplace", href: "/marketplace", icon: "shopping-cart" },
      ]
    },
    {
      title: "Content",
      items: [
        { label: "Create Post", href: "/create", icon: "file-text" },
        { label: "Drafts", href: "/drafts", icon: "book" },
        { label: "Scheduler", href: "/scheduler", icon: "calendar" },
        { label: "Templates", href: "/templates", icon: "briefcase" },
        { label: "Captions", href: "/captions", icon: "newspaper" },
        { label: "Hashtags", href: "/hashtags", icon: "dollar-sign" },
      ]
    },
    {
      title: "Insights",
      items: [
        { label: "Analytics", href: "/analytics", icon: "newspaper" },
        { label: "Performance", href: "/performance", icon: "briefcase" },
        { label: "Audience", href: "/audience", icon: "users" },
        { label: "Trends", href: "/trends", icon: "globe" },
    ...
    },
    {
      title: "Automation",
      items: [
        { label: "Auto-Engage", href: "/auto-engage", icon: "bot" },
        { label: "DM Automation", href: "/dm-automation", icon: "mail" },
    ...
    },
    {
      title: "Account",
      items: [
        { label: "Settings", href: "/settings", icon: "dollar-sign" },
        { label: "Help Center", href: "/help", icon: "help-circle" },
        { label: "Tutorials", href: "/tutorials", icon: "book" },
