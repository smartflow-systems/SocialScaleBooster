    ...
    <div className="min-h-screen bg-primary-black">
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="flex items-center gap-4 mb-6">
          ...
          <div>
            <h1 className="text-2xl font-bold text-white">DM Automation</h1>
            <p className="text-neutral-gray text-sm">Automate direct messages for lead generation and customer support</p>
          </div>
        </div>
