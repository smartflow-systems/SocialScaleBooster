    ...
    <div className="min-h-screen bg-primary-black">
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="border border-accent-gold/20 rounded-xl p-8 bg-rich-brown/20 text-center">
          <Settings className="w-16 h-16 text-accent-gold/40 mx-auto mb-4" />
          <h2 className="text-xl font-semibold text-white mb-2">Coming Soon</h2>
          <p className="text-neutral-gray max-w-md mx-auto">
            This feature is under development. Manage your account settings and preferences will be available soon.
          </p>
        </div>
      </div>
    </div>
