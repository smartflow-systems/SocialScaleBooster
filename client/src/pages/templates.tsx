    ...
    <div className="min-h-screen bg-[var(--sf-black)] text-white">
      <SfsContainer className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="flex items-center gap-4 mb-6">
          ...
          <div>
            <GoldHeading level={1} className="text-2xl font-bold">Templates</GoldHeading>
            <p className="text-neutral-400 text-sm">Browse and use pre-built content templates</p>
          </div>
        </div>
        <GlassCard className="p-8 text-center">
          <FileText className="w-16 h-16 text-[var(--sf-gold)]/40 mx-auto mb-4" />
          <GoldHeading level={2} className="text-xl font-semibold mb-2">Coming Soon</GoldHeading>
          <p className="text-neutral-400 max-w-md mx-auto">
            This feature is under development. Browse and use pre-built content templates will be available soon.
          </p>
        </GlassCard>
      </SfsContainer>
    </div>
