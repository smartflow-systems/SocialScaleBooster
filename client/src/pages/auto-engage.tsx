    ...
    <div className="min-h-screen bg-primary-black">
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="flex items-center gap-4 mb-6">
          ...
          <div>
            <h1 className="text-2xl font-bold text-white">Auto Engagement</h1>
            <p className="text-neutral-gray text-sm">Automate likes, comments, and follows to grow your audience</p>
          </div>
        </div>
        <div className="border border-accent-gold/20 rounded-xl p-8 bg-rich-brown/20 text-center">
          <Zap className="w-16 h-16 text-accent-gold/40 mx-auto mb-4" />
