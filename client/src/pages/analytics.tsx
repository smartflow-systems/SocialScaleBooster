      ...
      <SfsContainer className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="flex items-center gap-4 mb-6">
          <div className="w-12 h-12 bg-gradient-to-br from-[var(--sf-gold)] to-[var(--sf-gold-2)] rounded-xl flex items-center justify-center shadow-[var(--sf-glow-gold-sm)]">
            <Activity className="w-6 h-6 text-[var(--sf-black)]" />
          </div>
          <div>
            <GoldHeading level={1} className="text-2xl font-bold">Analytics</GoldHeading>
            <p className="text-neutral-400 text-sm">Track performance metrics, engagement, and ROI across all platforms</p>
          </div>
        </div>
        <GlassCard className="p-8 text-center">
          <Activity className="w-16 h-16 text-[var(--sf-gold)]/40 mx-auto mb-4" />
          <GoldHeading level={2} className="text-xl font-semibold mb-2">Coming Soon</GoldHeading>
          <p className="text-neutral-400 max-w-md mx-auto">
            This feature is under development. Track performance metrics, engagement, and ROI across all platforms will be available soon.
          </p>
        </GlassCard>
      </SfsContainer>
    </div>
