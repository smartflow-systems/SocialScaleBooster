        ...
        <div className="max-w-md w-full text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <Button
              ...
              className="bg-[#FFD700] text-[#0D0D0D] hover:bg-[#E6C200] font-bold"
            >
  ...
  return (
    <div className="min-h-screen bg-[#0D0D0D] flex items-center justify-center px-4" style={{ fontFamily: "'Inter', sans-serif" }}>
      <div className="max-w-md w-full text-center">
        ...
        <div className="w-20 h-20 rounded-2xl bg-[#FFD700]/10 border border-[#FFD700]/30 flex items-center justify-center mx-auto mb-6">
        ...
        <div className="inline-flex items-center gap-2 bg-[#FFD700]/10 border border-[#FFD700]/20 rounded-full px-4 py-1.5 mb-4">
          ...
          <span className="text-[#FFD700] text-sm font-semibold capitalize">{plan} Plan Activated</span>
        </div>
        ...
        <div className="bg-[#111] border border-white/5 rounded-2xl p-6 mb-8 text-left space-y-3">
        ...
        <Button
          onClick={() => setLocation("/dashboard")}
          className="w-full bg-[#FFD700] text-[#0D0D0D] hover:bg-[#E6C200] font-bold py-6 text-base"
        >
