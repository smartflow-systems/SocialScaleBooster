    ...
    <div className="min-h-screen bg-[var(--sf-black)] text-white">
      <SfsContainer className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="flex items-center gap-4 mb-6">
          ...
          <div>
            <GoldHeading level={1} className="text-2xl font-bold">Audience Builder</GoldHeading>
            <p className="text-neutral-400 text-sm">Build and segment your target audience for better engagement</p>
          </div>
        </div>
        <GlassCard className="p-8 text-center">
          <Users className="w-16 h-16 text-[var(--sf-gold)]/40 mx-auto mb-4" />
          <GoldHeading level={2} className="text-xl font-semibold mb-2">Coming Soon</GoldHeading>
          <p className="text-neutral-400 max-w-md mx-auto">
            This feature is under development. Build and segment your target audience for better engagement will be available soon.
          </p>
        </GlassCard>
      </SfsContainer>
    </div>
