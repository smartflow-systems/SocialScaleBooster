      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="flex items-center gap-4 mb-6">
          ...
          <div>
            ...
            <p className="text-neutral-gray text-sm">Find answers to common questions and get support</p>
          </div>
        </div>
        <div className="border border-accent-gold/20 rounded-xl p-8 bg-rich-brown/20 text-center">
          <HelpCircle className="w-16 h-16 text-accent-gold/40 mx-auto mb-4" />
