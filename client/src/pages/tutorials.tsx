      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="flex items-center gap-4 mb-6">
          ...
          <div>
            ...
            <p className="text-neutral-gray text-sm">Learn how to get the most out of SmartFlow AI</p>
          </div>
        </div>
        <div className="border border-accent-gold/20 rounded-xl p-8 bg-rich-brown/20 text-center">
          <BookOpen className="w-16 h-16 text-accent-gold/40 mx-auto mb-4" />
          <h2 className="text-xl font-semibold text-white mb-2">Coming Soon</h2>
          <p className="text-neutral-gray max-w-md mx-auto">
            This feature is under development. Learn how to get the most out of SmartFlow AI will be available soon.
          </p>
        </div>
      </div>
    </div>
