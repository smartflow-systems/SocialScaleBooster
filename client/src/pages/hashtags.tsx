      ...
      <SfsContainer className="max-w-5xl mx-auto px-4 py-8">
        ...
        <div className="flex items-center gap-4 mb-8">
          <div className="w-12 h-12 bg-gradient-to-br from-[var(--sf-gold)] to-[var(--sf-gold-2)] rounded-xl flex items-center justify-center shadow-[var(--sf-glow-gold-sm)]">
            <Hash className="w-6 h-6 text-[var(--sf-black)]" />
          </div>
          <div>
            <GoldHeading level={1} className="text-2xl font-bold">Hashtag Research</GoldHeading>
            <p className="text-neutral-400 text-sm">AI-powered hashtag suggestions to maximize your reach</p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          <GlassCard className="p-6">
            ...
            <div className="space-y-4">
              <div>
                <label className="text-sm text-neutral-400 mb-1 block">Topic / Niche</label>
                <textarea
                  value={topic}
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  <label className="text-sm text-neutral-400 mb-1 block">Number of Hashtags</label>
                  <select
                    value={count}
            ...
            <div className="flex items-center justify-between mb-4">
              ...
              {result && (
                <div className="flex items-center gap-2">
                  <span className="text-xs text-neutral-400">{tokensUsed} tokens</span>
            ...
            {loading ? (
              <div className="flex-1 flex items-center justify-center">
                <div className="text-center">
                  ...
                  <p className="text-neutral-400 text-sm">Finding the best hashtags...</p>
                </div>
              </div>
            ) : result ? (
              <div className="flex-1">
                <div className="bg-[var(--sf-black)] rounded-lg p-4 border border-[var(--sf-gold)]/10">
                  <p className="text-[var(--sf-gold)] whitespace-pre-wrap leading-loose text-lg">{result}</p>
                </div>
              </div>
            ) : (
              <div className="flex-1 flex items-center justify-center">
                <div className="text-center">
                  <Hash className="w-12 h-12 text-[var(--sf-gold)]/30 mx-auto mb-3" />
                  <p className="text-neutral-400 text-sm">Your hashtags will appear here</p>
                  <p className="text-neutral-500 text-xs mt-1">Enter a topic and click Find Hashtags</p>
                </div>
              </div>
            )}
          </GlassCard>
